...
class Matrix: public MatrixBase<Matrix<ElemType, RowsAtCompileTime, ColsAtCompileTime>> {
private:
    using Self = Matrix<ElemType, RowsAtCompileTime, ColsAtCompileTime>;
    friend MatrixBase<Self>;
...
auto operator << (ostream& os, MatrixBase<Derived> const& mat) -> ostream& {
